...
class ShiftReleaseRequest(TimestampedModel):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        constraints = [
            models.UniqueConstraint(fields=['shift', 'worker'], condition=models.Q(status='pending'), name='unique_pending_shift_release')
        ]
