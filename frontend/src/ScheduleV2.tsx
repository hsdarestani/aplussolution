...
export default function ScheduleV2({user}:{user:User}) {
  ...
  const intro=workerView?'Freie Einsätze finden und eigene Schichten verwalten.':clientView?'Geplante Einsätze und aktueller Besetzungsstatus für Ihre Aufträge.':'Kundenbedarf erstellen, prüfen und als OpenShift veröffentlichen.';
